        ...
        <div class="container"
            ...
            <div style="display: flex; gap: 40px; justify-content: center; flex-wrap: wrap;">
                <div style="display: flex; align-items: center; gap: 12px;">
                    ...
                    <span
                        style="color: rgba(255,255,255,0.9); font-size: 1rem; font-weight: 600;">hello@stuvalley.com</span>
                </div>
                <div style="display: flex; align-items: center; gap: 12px;">
                    <i class="fas fa-phone" style="color: rgba(255,255,255,0.8); font-size: 1.2rem;"></i>
                    <span style="color: rgba(255,255,255,0.9); font-size: 1rem; font-weight: 600;">+91 7292 050505</span>
                </div>
            </div>
        </div>
    </section>
