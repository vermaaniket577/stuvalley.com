                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="tag_text" class="form-control"
                                        value="{{ old('tag_text', $plan->tag_text) }}">
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label fw-bold">Theme & Highlight</label>
                                    <div class="form-check form-switch mt-2">
                                        <input class="form-check-input" type="checkbox" name="is_popular" id="is_popular" {{ old('is_popular', $plan->is_popular) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="is_popular">Is Most Popular (Glow
                                            Effect)</label>
                                    </div>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="is_light" id="is_light" {{ old('is_light', $plan->is_light) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="button_text" class="form-control"
                                        value="{{ old('button_text', $plan->button_text) }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold">Button Link</label>
                                    <input type="text" name="button_link" class="form-control"
                                        value="{{ old('button_link', $plan->button_link) }}">
                                </div>
                            </div>
