    ...
    <style>
        ...
        /* Glassmorphism Top Bar */
            ...
            #header-wrapper header {
                background: rgba(15, 23, 42, 0.5) !important; /* Semi-transparent dark blue-slate */
                backdrop-filter: blur(24px) !important; /* Strong blur */
                box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.2) !important; /* Soft shadow */
                border-bottom: 1px solid rgba(255, 255, 255, 0.08) !important; /* Glass edge */
            }
        ...
        <section class="portfolio-section"
            ...
            <div class="container" style="max-width: 1400px; margin: 0 auto; padding: 0 20px; position: relative; z-index: 2;">
                ...
                <div class="pro-carousel-wrapper">
                    <button type="button" id="pro-prev" class="pro-nav-btn"><i class="fas fa-arrow-left"></i></button>
                    ...
                    <button type="button" id="pro-next" class="pro-nav-btn"><i class="fas fa-arrow-right"></i></button>
                </div>
            </div>
