    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            ...
            <div
                ...
                {{-- Laravel Logo --}}
                <svg data-speed="0.5" class="w-full text-[#F53003] dark:text-[#F61500] transition-all translate-y-0 opacity-100 max-w-none duration-750 starting:opacity-0 starting:translate-y-6"
                ...
                {{-- Light Mode 12 SVG --}}
                <svg data-speed="1.2" class="w-[448px] max-w-none relative -mt-[4.9rem] -ml-8 lg:ml-0 lg:-mt-[6.6rem] dark:hidden"
                ...
                {{-- Dark Mode 12 SVG --}}
                <svg data-speed="1.2" class="w-[448px] max-w-none relative -mt-[4.9rem] -ml-8 lg:ml-0 lg:-mt-[6.6rem] hidden dark:block"
                    viewBox="0 0 440 376" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g
                        class="transition-all delay-300 translate-y-0 opacity-100 duration-750 starting:opacity-0 starting:translate-y-4">
                        <path
    ...
    <section class="testimonials-section">
        <div class="container mx-auto px-6 mb-12 text-center">
            <div class="section-title">
                ...
                <h2 class="text-3xl md:text-5xl font-bold mb-4 font-heading text-gradient-gold">Student Success Stories
                </h2>
                <p>Join thousands of satisfied learners achieving their dreams</p>
            </div>
        </div>
        ...
        <div class="marquee-wrapper">
            <div class="marquee-track">
                ...
                @php
                    $testimonials = [
                        ['name' => 'Sarah Johnson', 'role' => 'Full Stack Developer', 'rating' => 5, 'review' => 'The curriculum is absolutely world-class. I went from zero coding knowledge to a full-time job in just 6 months. The projects are real and challenging.'],
                        ['name' => 'Michael Chen', 'role' => 'Backend Engineer', 'rating' => 5, 'review' => 'I love the depth of the backend courses. Laravel coverage is unmatched. The community support is also fantastic.'],
                        ['name' => 'Emily Davis', 'role' => 'UI/UX Designer', 'rating' => 4, 'review' => 'Great designs and intuitive learning path. I really appreciated the focus on modern design principles alongside the coding.'],
                        ['name' => 'David Wilson', 'role' => 'Freelancer', 'rating' => 5, 'review' => 'This platform gave me the confidence to start my freelancing career. The portfolio projects I built here impressed my first clients.'],
                        ['name' => 'Jessica Brown', 'role' => 'Frontend Dev', 'rating' => 5, 'review' => 'React and Vue courses are up to date with the latest standards. Best investment for my career.'],
                    ];
                @endphp
